...
if (isset($_POST['submit'])) {
    ...
    $sl = mysqli_query($cn, "INSERT INTO `package`(`Packname`, `Category`, `Subcategory`, `Packprice`, `Pic1`, `Pic2`, `Detail`) VALUES ('$pname','$cateid','$subcateid','$packprice','$folder','$folder2','$detail')");
    if ($sl) {
            ...
            <div class="card mx-auto">
                ...
                <div class="card-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mx-auto ">
                            <img src="subcatimages/d.jpg" class="w-100 " id="pview" >  
                            <div class="text-center">
                                <label class="btn btn-primary btn-sm">
...
<div class="row mt-5">
    <div class="col-lg-10 text-right">
        <a href="packagein.php" class=" text-right btn btn-sm bg-info">Add</a>
</div>
<div class="row">
    <div class="col-lg-10 mx-auto" style=" max-height: 500px;overflow-y: scroll;">
        <table class="table table-responsive">
            ...
            <tbody>
                <?php
                $aa = "SELECT * FROM package INNER JOIN subcategory ON package.Subcategory=subcategory.Subcatid INNER JOIN category ON package.Category= category.Cat_id ORDER BY `Packid` DESC";
                ...
                while ($row1 = mysqli_fetch_object($us)):
                    ...
                    <tr>
                        ...
                        <td><?= $row1->Packprice ?></td>
                        <td><img src="packimages/<?= $row1->Pic1 ?>"  height="100px" width="100px"></td>
                        <td><img src="packimages/<?= $row1->Pic2 ?>"  height="100px" width="100px"></td>
                        <td><?= $row1->Detail ?></td>
                        <td><a href="packageupdate.php?id=<?= $row1->Packid ?>" class="btn btn-success btn-sm">Edit</a></td>
                        <td><a href="packagedelete.php?id=<?= $row1->Packid?>" class="btn btn-danger btn-sm">Delete</a></td>
